...
void initializeExtension( godot::ModuleInitializationLevel p_level )
{
    ...
    ClassDB::register_class<GDCesium3DTilesetSource>();
    ClassDB::register_class<GDCesium3DTilesetIonSource>();
    ClassDB::register_class<GDCesium3DTilesetUriSource>();
    
    ClassDB::register_class<GDCesium3DTileset>();
}
